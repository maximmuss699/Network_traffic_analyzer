...
% Hyperlink color setup with citation numbers in black
\hypersetup{
    colorlinks=true,
    urlcolor=blue,
    linkcolor=black,
...
% Redefine bibliography labels to include a colon after the number
\makeatletter
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{ipref.png}
    \caption{TCP Traffic Captured by \texttt{isa-top}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{ipref2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{udp.png}
    \caption{UDP Traffic Visualization in \texttt{isa-top}}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{udp2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{speedtest.png}
    \caption{\texttt{isa-top} Monitoring High-Bandwidth Traffic During a Speed Test}
\end{figure}

\section{References}
\begin{thebibliography}{9}
    \bibitem{libpcap} Libpcap Documentation [online]. 2024 [cit. 2024-04-01]. Available at: \url{https://www.tcpdump.org/manpages/pcap.3pcap.html}
    \bibitem{ncurses} Ncurses Documentation [online]. 2024 [cit. 2024-04-01]. Available at: \url{https://invisible-island.net/ncurses/man/ncurses.3x.html}
    \bibitem{beej} Beej. Beej's Guide to Network Programming: Using Internet Sockets [online]. 2023 [cit. 2024-04-01]. Available at: \url{https://beej.us/guide/bgnet/}
    \bibitem{linuxman} Linux Man Pages [online]. 2024 [cit. 2024-04-01]. Available at: \url{https://man7.org/linux/man-pages/}
    \bibitem{iperf} Iperf Documentation [online]. 2024 [cit. 2024-04-01]. Available at: \url{https://iperf.fr/}
    \bibitem{speedtest} Speedtest.net [online]. 2024 [cit. 2024-04-01]. Available at: \url{https://www.speedtest.net}
\end{thebibliography}
